...
// ==========================================
// KAS SYSTEM - LANGSUNG DI admin.js
// ==========================================
...
// WARNING: Jangan deklarasi ulang escapeHtml dan showToast! Sudah ada di admin.js
...
function renderKasUI() {
    ...
    // SEMENTARA: Tampilkan JSON dulu untuk memastikan data masuk
...
async function initKasDashboardFromAdmin(admin) {
    console.log("🎯 initKasDashboard called for:", admin?.nama);
    currentAdminKas = admin;
    await loadKasData();
}

// Timpa fungsi yang sudah ada atau tambahkan yang baru
window.initKasDashboard = initKasDashboardFromAdmin;
